...
import com.unifyed.attendance.controller.FacultyController;
...
public class AdminService {
	...
	public String postCourse(Course course) {
		...
		logger.debug("Course data saved");
	...
	public String putCourse(Map<String, Object> requestBody) {
		try {
			...
			logger.debug("Fetched course detail :" + course.toString());
			if (course == null)
	...
	public String postSpecialization(Map<String, Object> requestBody) {
		...
		logger.debug("Semester data saved");
	...
	public String putSpecialization(Map<String, Object> requestBody) {
		...
		logger.debug("Course info :" + course.toString());
		logger.debug("Specialization info :" + oldSpecialization.toString());
		if (course == null)
			return "Course " + requestBody.get("course").toString() + " doesn't exist";
	...
	public String postSemester(Map<String, Object> requestBody) {
		Course course = courseRepository.findOne(requestBody.get("course").toString());
		Specialization specialization = specializationRepository.findOne(requestBody.get("specialization").toString());
		logger.debug("Course info :" + course.toString());
		logger.debug("Specialization info :" + specialization.toString());
	...
	public Subject postSubject(Subject requestBody) throws JSONException {
		...
		logger.debug("Subject data saved");
		return newSubject;
	}
